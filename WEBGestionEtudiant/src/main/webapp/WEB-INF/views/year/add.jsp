		        ...
		        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
				  ...
				  <div class="card">
				  	...
				  	<div class="card-header">
				  		<h4>Formulaire d'ajout d'une année académie</h4>
				  	</div>
				  	...
				  	<div class="card-body">
				  		<form action="add" method="post" class="form-group">
				  			...
				  			<div class="mb-2">
								<h6 class="form-group">Nom de l'année académie</h6>
								<input type="text" name="name"
									placeholder="Entrer de l'année ..." class="form-control" required>
							</div>
