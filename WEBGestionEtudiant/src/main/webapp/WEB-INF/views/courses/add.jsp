        ...
        <div class="row py-2 px-lg-5">
            <div class="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center text-white">
                    <small><i class="fa fa-phone-alt mr-2"></i>+221 77 285 50 46</small>
                    <small class="px-3">|</small>
                    <small><i class="fa fa-envelope mr-2"></i>mdiop@gmail.com</small>
                </div>
            </div>
		        ...
		        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
				  ...
				  <div class="card">
				  	...
				  	<div class="card-header">
				  		<h4>Formulaire d'ajout d'un cours</h4>
				  	</div>
				  	...
				  	<div class="card-body">
				  		<form action="add" method="post" class="form-group">
				  			...
				  			<div class="mb-2">
								<h6 class="form-group">Nom du cours</h6>
								<input type="text" name="name"
									placeholder="Entrer le nom du cours ..." class="form-control" required>
							</div>
							
							<div class="mb-2">
								<h6 class="form-group">Programme</h6>
								<input type="text" name="program"
									placeholder="Entrer le programme du cours ..." class="form-control" required>
							</div>
							
							<c:if test="${ msg_confirmation != null }">
								<h6 class="form-group text-center text-success">
									 <script type="text/javascript">
									      window.setTimeout(msg_confirmation, 3000);
									 </script>
