		        ...
		        <div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
				  ...
				  <div class="card">
				  	...
				  	<div class="card-header">
				  		<h4>Formulaire d'ajout d'un étudiant</h4>
				  	</div>
				  		...
				  		<form action="add" method="post" class="form-group">
				  			...
				  			<div class="mb-2">
								...
								<input type="text" name="firstname"
									placeholder="Entrer le prenom de l'étudiant ..." class="form-control" required>
							</div>
							
							<div class="mb-2">
								<h6 class="form-group">Nom</h6>
								<input type="text" name="lastname"
									placeholder="Entrer le nom de l'étudiant ..." class="form-control" required>
							</div>
							
							<div class="mb-2">
								<h6 class="form-group">Date de naissance</h6>
								<input type="date" name="birthday"
									placeholder="Entrer la date de naissance de l'étudiant ..." class="form-control" required>
							</div>
							
							<div class="mb-2">
								<h6 class="form-group">Téléphone</h6>
								<input type="text" name="phone"
									placeholder="Entrer le numéro de téléphone de l'étudiant ..." class="form-control" required>
							</div>
